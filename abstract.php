...
function describe($bird)
{
    if ($bird instanceof Bird) {
        ...
        exit('This is not a bird. I cannot describe it.');
    }
}
...
abstract class AbstractClass
{
    ...
    abstract public static function display(): string; //  abstract method that is declare as static is must be static at the time of implementation otherwise that will cause the error and stop the execution of the script
